...
import com.baeldung.springsoap.gen.GetSumRequest;
import com.baeldung.springsoap.gen.GetSumResponse;
...
public class CountryEndpoint {
    ...
    public GetSumResponse getSum(@RequestPayload GetSumRequest request) {
        ...
        response.setSumme(request.getZahl1()+request.getZahl2()+request.getZahl3());
